...
public class MainActivity2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGuardar.setOnClickListener(v -> {
            ...
            uploadPhotoFirestore(); // Luego llamar a uploadPhotoFirestore()
        });
    ...
    private void guardarUsuario(){
        try{
            ...
            if( miToken!=null && miToken!="" ){
                usuarios user = new usuarios(nombre, "carinmorales@gmail", urlCompleteImg, urlCompleteImgFirestore, miToken);
                if(key!=null){
    ...
    void tomarFoto() {
        ...
        imgPhoto.setOnClickListener(v->{
            ...
            if (takePhotoIntent.resolveActivity(getPackageManager()) != null) {
                ...
                if (photoFile != null) {
                    try {
                        Uri photoURI = FileProvider.getUriForFile(MainActivity2.this, "com.ugb.miapp2.fileprovider", photoFile);
